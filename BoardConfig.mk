...
# recovery
TARGET_RECOVERY_FSTAB := device/nexell/drone/recovery.fstab
TARGET_RELEASETOOLS_EXTENSIONS := device/nexell/drone
TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_drone
TARGET_RECOVERY_UI_LIB := librecovery_ui_drone
...
# external ffmpeg plugin for nxp4330
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 15805186048
